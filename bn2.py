...
class Buildetwork(object):
    ...
    def create_epg_stat_bnd(self,xl_file):
        ...
        set_of_tenants = set()
        set_of_AppProf = set() #this will read all App profiles irrespective of tenant I think that it will work still but there might be a better way to do this - ask J
        epg_encap = ''
        epg_paths_tDN = ''
        epg_protpaths_tDN = ''
        results = []
